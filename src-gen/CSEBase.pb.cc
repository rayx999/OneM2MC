...
void protobuf_AddDesc_CSEBase_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\032\021CommonTypes.proto\"\300\001\n\007CSEBase\0229\n\003cst\030d"
    ...
    "rtedResourceType\022\013\n\003poa\030g \003(\t\022\n\n\002nl\030h \001("
    "\t\022\013\n\003ncp\030i \001(\tb\006proto3", 262);
        ...
        if (tag == 826) {
         parse_poa:
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            ...
            ::google::protobuf::internal::WireFormat::PARSE,
            "MicroWireless.OneM2M.pb.CSEBase.poa");
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(826)) goto parse_poa;
